    ...
    def Render_Games(self, printer=False):
        ...
        for game in game_data:
            ...
            while True:
                ...
                graphics.DrawText(canvas, self.font2, 64 - len(str(spread))*4, 16, graphics.Color(0, 0, 255), spread)
                graphics.DrawText(canvas, self.font, 1, 17, graphics.Color(self.team_colors[hometeam][1][0], self.team_colors[hometeam][1][1], self.team_colors[hometeam][1][2]), hometeam)
                ...
                if game['gameStatus'] == 2: #game is live
                    ...
                    if timeremaining[0] == 'Q' and (timeremaining[1] >= '4' and (timeremaining[3] == '0' and timeremaining[4] <= '4')): #Q4 or OT < 5min remaining
                        ...
                        graphics.DrawText(canvas, self.font2, 2, 25, graphics.Color(200, 200, 200), timeremaining)
                ...
                if game['gameStatus'] != 1 and homeleadername is not None and awayleadername is not None:
                    ...
                    len1 = graphics.DrawText(canvas, self.font2, posx, 31, graphics.Color(255, 255, 255), awaystatline + '  ' + homestatline)
