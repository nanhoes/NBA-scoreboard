...
6. SSH into pi, run `sudo raspi-config`, System Options > Network at Boot > Yes, Localisation Options > Timezone, change hostname and password, `sudo nano /boot/config.txt` set dtparam=audio=off.
