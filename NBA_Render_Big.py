...
class Render:
    def __init__(self):
        ...
        self.font.LoadFont("/home/pi/My-NBA-scoreboard/share-tech-mono.regular.bdf")
        self.font2 = graphics.Font()
        self.font2.LoadFont("/home/pi/My-NBA-scoreboard/rpi-rgb-led-matrix/fonts/10x20.bdf")
        ...
        for game in game_data:
          ...
          #  image.thumbnail((30, matrix.height))
           ...
           # canvas = matrix.SwapOnVSync(canvas)
            ...
            graphics.DrawText(canvas, self.font, 0, 36, graphics.Color(self.team_colors[hometeam][1][0], self.team_colors[hometeam][1][1], self.team_colors[hometeam][1][2]), hometeam)
            graphics.DrawText(canvas, self.font, 0, 16, graphics.Color(self.team_colors[awayteam][1][0], self.team_colors[awayteam][1][1], self.team_colors[awayteam][1][2]), awayteam)
            ...
            if game['gameStatus'] == 3: #finished game
                graphics.DrawText(canvas, self.font, 1, 56, graphics.Color(255, 0, 0), game['gameStatusText'].upper()) #red '"final" text
                if homescore > awayscore:
