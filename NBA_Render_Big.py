    ...
    def Render_Games(self, printer=False):
        ...
        for game in game_data:
            ...
            #            graphics.DrawText(canvas, self.font2, 41, 14, graphics.Color(200, 200, 200), 'HELLO') #away team record
                ...
                #canvas.Clear()
                len1 = graphics.DrawText(canvas, self.font2, pos, 62, graphics.Color(self.team_colors[hometeam][0][0], self.team_colors[hometeam][0][1], self.team_colors[hometeam][0][2]), awaystatline.upper() + homestatline.upper())
