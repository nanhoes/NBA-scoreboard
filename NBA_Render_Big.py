        ...
        for game in game_data:
          ...
          #  image.thumbnail((30, matrix.height))
           ...
           # canvas = matrix.SwapOnVSync(canvas)
            ...
            graphics.DrawText(canvas, self.font2, 128 - len(str('232'))*8, 14, graphics.Color(0, 0, 200), '232')#over_under)
            graphics.DrawText(canvas, self.font2, 128 - len(str('-5'))*8, 34, graphics.Color(0, 0, 200), '-5')#spread)
