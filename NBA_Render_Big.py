...
class Render:
    def __init__(self):
        ...
        self.font.LoadFont("/home/pi/My-NBA-scoreboard/rpi-rgb-led-matrix/fonts/texgyre-27.bdf")
        self.font2 = graphics.Font()
        self.font2.LoadFont("/home/pi/My-NBA-scoreboard/rpi-rgb-led-matrix/fonts/8x13.bdf")
          ...
          #  image.thumbnail((30, matrix.height))
           ...
           # canvas = matrix.SwapOnVSync(canvas)
            ...
            if game['gameStatus'] == 1: #upcoming game
                ...
                graphics.DrawText(canvas, self.font2, 42, 34, graphics.Color(100, 100, 100), homerecord) #home team record
